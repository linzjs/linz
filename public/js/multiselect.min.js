...
!(function($) {
        ...
        ko.bindingHandlers.multiselect = {
            init: function(
                ...
                if (isObservableArray(listOfSelectedItems)) {
                    ...
                    $(element).multiselect(
                        'select',
                        ko.utils.unwrapObservable(listOfSelectedItems)
                    );
                    // Subscribe to the selectedOptions: ko.observableArray
                    listOfSelectedItems.subscribe(
                        function(changes) {
                            var addedArray = [],
                                deletedArray = [];
    ...
    Multiselect.prototype = {
        ...
        dataprovider: function(dataprovider) {
            ...
            $.each(dataprovider, function(index, option) {
                if ($.isArray(option.children)) {
                    ...
                    optionDOM +=
                        '<optgroup label="' +
                        (option.title || 'Group ' + groupCounter) +
                        '">';
        ...
        updateSelectAll: function() {
            if (this.hasSelectAll()) {
                var allBoxes = $(
                    ...
                    selectAllLi = $(
                        'li.' + this.options.selectAllValue,
                        this.$ul
                    ),
        ...
        updateButtonText: function() {
            ...
            $('button', this.$container).html(
                this.options.buttonText(options, this.$select)
            );

            // Now update the title attribute of the button.
            $('button', this.$container).attr(
                'title',
