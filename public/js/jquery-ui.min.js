                ...
                s.scrollParent[0] !== o && 'HTML' !== s.scrollParent[0].tagName
                    ...
                    : ((n.axis && 'x' === n.axis) ||
                          (t.pageY - e(o).scrollTop() < n.scrollSensitivity
                              ? (a = e(o).scrollTop(
                                    e(o).scrollTop() - n.scrollSpeed
                                ))
                              : e(window).height() -
                                    (t.pageY - e(o).scrollTop()) <
                                    n.scrollSensitivity &&
                                (a = e(o).scrollTop(
                                    e(o).scrollTop() + n.scrollSpeed
                                ))),
                      (n.axis && 'y' === n.axis) ||
                          (t.pageX - e(o).scrollLeft() < n.scrollSensitivity
                              ? (a = e(o).scrollLeft(
                                    e(o).scrollLeft() - n.scrollSpeed
                                ))
                              : e(window).width() -
                                    (t.pageX - e(o).scrollLeft()) <
                                    n.scrollSensitivity &&
                                (a = e(o).scrollLeft(
                                    e(o).scrollLeft() + n.scrollSpeed
                                )))),
                ...
                switch (s) {
                    ...
                    case 'pointer':
                        return (
                            ...
                            e(a, d, i.proportions().height) &&
                                e(n, u, i.proportions().width)
                        );
                    case 'touch':
                        return (
                            ((r >= d && p >= r) ||
