        ...
        function i(a) {
            if (!s) {
                ...
                if (d) {
                    this.commit(f, d);
                    for (
                        var a = [].concat(a), e = a.length, c, g = 0;
                        g < e;
                        g++
                    )
            ...
            onOk: function() {
                if (this.imageEditMode) {
                    ...
                    confirm(c.lang.image.button2Img)
                        ? ((this.imageElement = c.document.createElement(
                              'img'
                          )),
                                    ...
                                    children: [
                                        {
                                            ...
                                            onChange: function() {
                                                ...
                                                if (0 < b.length) {
                                                    ...
                                                    var c = CKEDITOR.document.getById(
                                                        m
                                                    );
                                                    c &&
                                                        c.setStyle(
                                    ...
                                    children: [
                                        {
                                            ...
                                            children: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    onLoad: function() {
                                                        var a = CKEDITOR.document.getById(
                                                                u
                                                            ),
                                                            b = CKEDITOR.document.getById(
                                                                p
                                                            );
                                                        a &&
                                                            (a.on(
