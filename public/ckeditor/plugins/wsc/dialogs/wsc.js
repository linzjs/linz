...
(function() {
        ...
        if (0 === d.options.length) {
            ...
            for (var k = 0; k < i.length; k++)
                (g = document.createElement('option')),
                    g.setAttribute('value', i[k][1]),
                    (e = document.createTextNode(i[k][0])),
                    g.appendChild(e),
                    i[k][1] == a.selectingLang &&
    ...
    a.buildOptionSynonyms = function(b) {
        var b = a.selectNodeResponce[b],
            c = q(a.selectNode.synonyms);
    ...
    var s = function(a) {
        ...
        C = function(b, c, d) {
            var f = new CKEDITOR.dom.element('div'),
                e = new CKEDITOR.dom.element('input'),
        ...
        n = function(b) {
            ...
            x[c.getCurrentLangGroup(a.selectingLang)]();
            w(a.show_grammar);
            b.onchange = function() {
                x[c.getCurrentLangGroup(this.value)]();
                w(a.show_grammar);
                a.div_overlay.setEnable();
        ...
        F = {
            iframeOnload: function() {
                ...
                v(a.targetFromFrame[a.iframeNumber + '_' + b], a.cmd[b]);
            },
            ...
            grammerSuggest: function(b) {
                ...
                for (
                    var b = b.grammSuggest, c = b.length, d = !0, f = 0;
                    f < c;
                    f++
                )
                    a.grammerSuggest.getElement().append(C(b[f], b[f], d)),
                        (d = !1);
                l();
                a.div_overlay.setDisable();
            },
            thesaurusSuggest: function(b) {
                ...
                var c = q(a.selectNode.categories),
                    d = 0;
                ...
                b = a.selectNode.categories.getInputElement().getChildren().$[0]
                    .value;
                a.selectNode.categories
                    .getInputElement()
                    .getChildren().$[0].selected = !0;
            ...
            ReplaceText: function(b) {
                ...
                A(a.LocalizationButton);
                B(a.LocalizationLabel);
            },
        ...
        y = function(a) {
            a = a || window.event;
            if ((a = window.JSON.parse(a.data)) && a.id) F[a.id](a);
        },
        v = function(b, c, d, f) {
        ...
        E = function() {
            ...
            setTimeout(function() {
                ...
                if (
                    !e.misc.hasClass(c, 'cke_dialog_tab') &&
                    !e.misc.hasClass(c, 'cke_dialog_contents_body') &&
                    e.misc.isVisible(c)
                )
                    try {
                        c.focus();
                    ...
                    for (var g = 0, h; g < d.count(); g++)
                        if (((h = d.getItem(g)), e.misc.isVisible(h.$))) {
                            try {
                                h.$.focus();
                            } catch (i) {}
                            break;
    ...
    CKEDITOR.dialog.add('checkspell', function(b) {
        ...
        return {
            ...
            onShow: function() {
                ...
                a.TextAreaNumber =
                    'cke_textarea_' + CKEDITOR.currentInstance.name;
                e.postMessage.init(y);
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    CKEDITOR.scriptLoader.load(
                        ...
                        function(c) {
                            ...
                            c && (G(a.dialog), a.dialog.setupContent(a.dialog));
                        }
                    );
                } else a.dialog.hide();
            },
            onHide: function() {
                ...
                b.unlockSelection();
                c &&
                    (f && c.state[b.name] && f.setMarkupPaused) &&
                    f.setMarkupPaused(!1);
                a.dataTemp = '';
                e.postMessage.unbindHandler(y);
            },
            contents: [
                {
                    id: 'SpellTab',
                                        ...
                                        },
                                        {
                                            ...
                                            children: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    title: 'Finish Checking',
                                                    style:
                                                        'width: 133px; float: right; margin-top: 9px;',
                                                    onLoad: function() {
                                                        this.getElement().setAttribute(
                                                            'title-cmd',
                                                            this.id
                ...
                },
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            id: 'bottomGroup',
                            style:
                                'width:560px; margin: -10px auto; overflow: hidden;',
                            children: [
                                {
                                    type: 'hbox',
                                    widths: ['75%', '25%'],
                                        ...
                                        },
                                        {
                                            ...
                                            children: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    title: 'Finish Checking',
                                                    style:
                                                        'width: 121px; float: right; margin-top: 9px;',
                                                    onLoad: function() {
                                                        this.getElement().setAttribute(
                                                            'title-cmd',
                                                            this.id
    ...
    CKEDITOR.dialog.on('resize', function(b) {
        var b = b.data,
            c = b.dialog,
            d = CKEDITOR.document.getById(
                a.iframeNumber + '_' + c._.currentTabId
            );
        'checkspell' == c._.name &&
            (a.bnr
