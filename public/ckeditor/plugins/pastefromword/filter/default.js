            ...
            filters: {
                ...
                assembleList: function(a) {
                        ...
                        if (((b = c[n]), 'cke:li' == b.name))
                            if (
                                ...
                                if (j) {
                                    if (d > e)
                                        a.push(
                                            (j = new CKEDITOR.htmlParser.element(
                                                l
                                            ))
                                        ),
                                            j.add(b),
                                    ...
                                    a.push(
                                        (j = new CKEDITOR.htmlParser.element(l))
                                    ),
                                        j.add(b),
                                        (c[n] = j);
                                h = b;
                    ...
                    for (n = 0; n < a.length; n++)
                        if (
                            ...
                            (c = /list-style-type:(.*?)(?:;|$)/),
                            (e =
                                CKEDITOR.plugins.pastefromword.filters
                                    .stylesFilter),
                            (g = j.attributes),
                            !c.exec(g.style))
                        ) {
                ...
                elementMigrateFilter: function(a, c) {
                    return a
                        ? function(b) {
                              var f = c
                                  ? new CKEDITOR.style(a, c)._.definition
                                  : a;
                              b.name = f.element;
                ...
                return {
                    ...
                    elements: {
                        ...
                        'div': function(a) {
                            ...
                            if (c && 'table' == c.name) {
                                var b = a.attributes;
                                c.attributes = CKEDITOR.tools.extend(
                                    c.attributes,
                                    b
                                );
                            ...
                            if (p(a.parent)) delete a.name;
                                ...
                                'font' == e.name
                                    ...
                                    : ((d = (d || '').split(';')),
                                      b.color &&
                                          ('#000000' != b.color &&
                                              d.push('color:' + b.color),
                                          delete b.color),
                                      b.face &&
                                          (d.push('font-family:' + b.face),
                                          delete b.face),
                                      b.size &&
                                          (d.push(
                                              'font-size:' +
                    ...
                    comment: !CKEDITOR.env.ie
                        ? function(a, b) {
                              ...
                              return d
                                  ...
                                  ? ((c = CKEDITOR.htmlParser.fragment.fromHtml(
                                        c[0]
                                    ).children[0]),
                                    (d =
                                        (d =
