...
CKEDITOR.plugins.setLang('a11yhelp', 'fr', {
    ...
    contents:
        "Contenu de l'aide. Pour fermer ce dialogue, appuyez sur la touche Ech (Echappement).",
    legend: [
        {
            name: 'Général',
            items: [
        ...
        },
        {
            ...
            items: [
                ...
                {
                    name:
                        "Accéder à la précédente commande d'espace de mise au point",
                    legend:
                ...
                {
                    name:
                        "Accès à la prochaine commande de l'espace de mise au point",
                    legend:
