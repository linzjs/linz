CKEDITOR.dialog.add('scaytDialog', function(f) {
                                ...
                                children: [
                                    {
                                        ...
                                        onClick: function() {
                                            ...
                                            c.createUserDictionary(
                                                ...
                                                function(b) {
                                                    b.error ||
                                                        e.toggleDictionaryButtons.call(
                                                            a,
                                                            !0
                                                        );
                                                    b.dialog = a;
                                        ...
                                        onClick: function() {
                                            ...
                                            e.restoreUserDictionary(
                                                ...
                                                function(b) {
                                                    b.dialog = a;
                                                    b.error ||
                                                        c.toggleDictionaryButtons.call(
                                                            a,
                                                            !0
                                                        );
                                                    b.command = 'restore';
                ...
                elements: [
                    {
                        ...
                        html:
                            '<div><div id="scayt_about_">' + k + '</div></div>',
                    },
                ],
            },
        ];
    f.on('scaytUserDictionaryAction', function(a) {
        ...
        void 0 === a.data.error
            ...
            : ('' === a.data.name
                  ...
                  : ((f = b.getLocal(
                        'message_error_' + a.data.command + 'Dic'
                    )),
                    (f = f.replace('%s', a.data.name)),
                    d.setText(f)),
              e.css(d.$, { color: 'red' }),
              null != b.getUserDictionaryName() &&
              '' != b.getUserDictionaryName()
                  ? c
    ...
    var j = {
        ...
        renderLangList: function(a) {
            ...
            for (h in d)
                i++, this.buildRadioInputs(d[h], h).appendTo(i <= b ? e : a);
        },
