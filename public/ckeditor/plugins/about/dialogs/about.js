                ...
                elements: [
                    {
                        ...
                        html:
                            ...
                            ' (revision ' +
                            CKEDITOR.revision +
                            ')<br><a target="_blank" href="http://ckeditor.com/">http://ckeditor.com</a></p><p>' +
                            a.help.replace(
                                '$1',
                                '<a target="_blank" href="http://docs.ckeditor.com/user">' +
                                    a.userGuide +
                                    '</a>'
                            ) +
                            '</p><p>' +
                            a.moreInfo +
                            '<br><a target="_blank" href="http://ckeditor.com/about/license">http://ckeditor.com/about/license</a></p><p>' +
                            a.copy.replace(
                                '$1',
                                '<a target="_blank" href="http://cksource.com/">CKSource</a> - Frederico Knabben'
                            ) +
                            '</p></div>',
                    },
                ],
