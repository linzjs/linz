    ...
    CKEDITOR.dialog.add('link', function(g) {
        var l = CKEDITOR.plugins.link,
            m = function() {
                ...
                if (b && a)
                    switch (
                        ((b = b.getElement()), b.hide(), a.setValue(''), k)
                    ) {
                        case 'frame':
        ...
        return {
            ...
            onShow: function() {
                var a = this.getParentEditor(),
                    b = a.getSelection(),
                    c = null;
                (c = l.getSelectedLink(a)) && c.hasAttribute('href')
