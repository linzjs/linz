...
exports.getAdminPasswordResetLink = function () {
    return linz.get('admin path') + linz.get('admin password reset path');
}

exports.getAdminForgotPasswordLink = function () {
    return linz.get('admin path') + linz.get('admin forgot password path');
}
