...
var localDateTimeRenderer = module.exports.datetimeLocal = function localDateTimeRenderer (date, record, fieldName, model, callback) {
...
var referenceValueRenderer = module.exports.referenceValue = function referenceValueRenderer (val, record, fieldName, model, callback) {
...
var defaultRenderer = module.exports.default = function defaultRenderer(val, record, fieldName, model, callback) {
    ...
    if (typeof val === 'number') {
        return textRenderer(val, record, fieldName, model, callback);
    }
