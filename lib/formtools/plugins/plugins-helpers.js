...
var defaults = function (options, schema, isEmbeddedDocument = false) {
     ...
     * label defaults
     */
    options.labels = labelDefaults(options.labels || {}, Object.keys(schema.paths));
...
var listDefaults = function (list, labels, titleField) {
    ...
    list.search = Object.keys(list).includes('search') ? list.search : [ 'title' ];
...
var formSettings = function (req, schema, form, labels) {
    ...
    return linz.api.formtools.decorateDocumentArrayFields(req, sortedFormConfigs);
