...
var defaults = function (options, isEmbeddedDocument) {
    ...
    */
    ...
    // * grid defaults
    // */
    gridDefaults(options.grid, options.labels);

    /**
    * overview defaults
    */

    overviewDefaults(options.overview);
...
var filtersDefault = function (filters, labels) {
    ...
    Object.keys(filters).forEach(function (key) {
        ...
        filters[key].label = filters[key].label || labels[key] || key;
...
var formConfigDefault = function (keyName, schemaConfig, formConfig, labels) {
    ...
    var obj = {
        label: formConfig.label || labels[keyName] || keyName || '',
...
var overviewSettings = function (overview, labels) {
    ...
    if (overview.summary.fields) {
        Object.keys(overview.summary.fields).forEach(function (fieldName) {
            overview.summary.fields[fieldName].label = overview.summary.fields[fieldName].label || labels[fieldName] || fieldName;
        });
    }
