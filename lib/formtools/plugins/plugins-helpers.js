...
var defaults = function (options, isEmbeddedDocument) {
    ...
    */
    ...
    options.form.dateCreated = { label: 'Date created', visible: false, fieldset: 'Summary' };
    options.form.dateModified = { label: 'Date modified', visible: false, fieldset: 'Summary' };
...
var overviewDefaults = function (overview, labels) {
    ...
    // set default for overview details
    overview.details = overview.details || ['dateCreated', 'dateModified'];
...
var getOverviewFields = function (form, fields) {
