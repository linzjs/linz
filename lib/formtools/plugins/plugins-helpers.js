...
var defaults = function (options, isEmbeddedDocument) {
    ...
    */
     ...
     */
    permissionsDefaults(options);

    return options;

};

var permissionsDefaults = function (options) {

    // defaults to {}
    options.permissions = options.permissions || {};

    // defaults to true
    options.permissions.canEdit = !(options.permissions.canEdit === false);
    options.permissions.canDelete = !(options.permissions.canDelete === false);
    options.permissions.canList = !(options.permissions.canList === false);
    options.permissions.canCreate = !(options.permissions.canCreate === false);
    options.permissions.canExport = !(options.permissions.canExport === false);
    options.permissions.canView = !(options.permissions.canView === false);
    options.permissions.canViewRaw = !(options.permissions.canViewRaw === false);

    return options;

};

var gridDefaults = function (options) {
...
module.exports = {
    ...
    permissionsDefaults: permissionsDefaults,
