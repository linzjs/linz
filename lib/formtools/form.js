        ...
        async.series([
            ...
            function (callback) {
                ...
                switch (field.type) {
                    ...
                    case 'email':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (field.widget || linz.formtools.widgets.email)(fieldName, field, fieldValue));
                        break;

                    case 'boolean':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (field.widget || linz.formtools.widgets.boolean)(fieldName, field, fieldValue));
                        break;

                    case 'enum':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (field.widget || linz.formtools.widgets.select)(fieldName, field, fieldValue));
                        break;

                     case 'array':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (field.widget || linz.formtools.widgets.checkboxes)(fieldName, field, fieldValue));
                        break;

                    case 'password':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (field.widget || linz.formtools.widgets.password)(fieldName, field, fieldValue));
                        break;

                    default:
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (field.widget || linz.formtools.widgets.text)(fieldName, field, fieldValue));
                        break;
