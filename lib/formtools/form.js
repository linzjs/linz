            ...
            function (callback) {
                ...
                (function (cb) {
                    ...
                    switch (field.type) {
                        ...
                        //
                        // case 'datetimeLocal':
                        //     wFn = (widget || linz.api.formtools.widget.get('datetimelocal'));
                        //     break;
                        //
                        // case 'url':
                        ...
                        //
                        // case 'hidden':
                        //     wFn = (widget || linz.api.formtools.widget.get('hidden'));
                        //     break;
                        //
                        // case 'number':
                        ...
                        //
                        // case 'digit':
                        //     wFn = (widget || linz.api.formtools.widget.get('digit'));
                        //     break;
                        //
                        // case 'tel':
                        ...
                        //
                        // case 'documentarray':
                        //     wFn = (widget || linz.api.formtools.widget.get('documents'));
                        //     break;

                        default:
                            Widget = (widget || linz.formtools.widgets.text);
                            break;
                    ...
                    switch (field.type) {
                        ...
                        // case 'documentarray':
                        //     w = new Widget(fieldName, field, fieldValue, r, formType, embeddedDocumentForm).render();
                        //     break;

                        default:
                            w = new Widget(fieldName, field, fieldValue, r, formType).render();
                            break;
