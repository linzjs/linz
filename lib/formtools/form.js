    ...
    async.eachSeries(Object.keys(formFields), function (fieldName, fn) {
        ...
        async.series([
            ...
            function (callback) {
                ...
                if (field.transpose && typeof field.transpose === 'function') {

                    fieldValue = field.transpose(r[fieldName], r);
                    ...
                    switch (fieldType) {
                        ...
                        case 'date':
                        case 'datetime':
                            fieldValue = r[fieldName] !== undefined && r[fieldName] !== null ? moment(r[fieldName]).toISOString() : defaultValue;
                        break;
