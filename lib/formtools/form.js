        ...
        async.series([
            ...
            function (callback) {
                ...
                switch (field.type) {
                    ...
                    case 'email':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.email())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'boolean':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.boolean())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'enum':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.select())(fieldName, field, fieldValue, r, formType));
                        break;

                     case 'array':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.checkboxes())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'password':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.password())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'text':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.textarea())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'date':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.date())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'datetime':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.datetime())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'datetimeLocal':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.datetimeLocal())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'url':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.url())(fieldName, field, fieldValue, r, formType));
                        break;

                    case 'hidden':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.hidden())(fieldName, field, fieldValue, r, formType));
                        break;
                    ...
                    case 'documentarray':
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.documents())(fieldName, field, fieldValue));
                        break;

                    default:
                        addToFormOrFieldset(form, fieldsets, field.fieldset, (widget || linz.formtools.widgets.text())(fieldName, field, fieldValue, r, formType));
                        break;
