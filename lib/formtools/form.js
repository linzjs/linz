...
var addToFormOrFieldset = function (form, fieldsets, fieldsetKey, element, callback) {
            ...
            function (callback) {
                ...
                (function (cb) {
                    ...
                    if (field.type === 'documentarray') {
                        ...
                        wFn(fieldName, field, fieldValue, r, formType, function (err, widgetResult) {

                            w = widgetResult;
                            addToFormOrFieldset(form, fieldsets, field.fieldset, w, function () {
                                return callback(null);
                            });
