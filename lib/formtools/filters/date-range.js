...
module.exports = {
    renderer: function dateFilterRenderer (fieldName, callback) {
        return callback(null, '<input type="date" name="' + fieldName + '[dateFrom][]" class="form-control" style="width:50%;"><input type="date" name="' + fieldName + '[dateTo][]" class="form-control" style="width:50%;">');
    },
    ...
    bind: function dateRangeFieldBinder (fieldName, form, callback) {
        ...
        for (var i = 0; i < form[fieldName].dateFrom.length; i++) {
            ...
            html.push('<input type="date" name="' + fieldName + '[dateFrom][]" class="form-control" style="width:50%;" value="' + dateFrom + '"><input type="date" name="' + fieldName + '[dateTo][]" class="form-control" style="width:50%;" value="' + dateTo + '">');
