...
module.exports = (dateFormat = 'YYYY-MM-DD') => ({
    ...
    renderer: function dateRangeFilterRenderer (fieldName, callback) {
        return callback(null, '<template><span><input type="text" name="' + fieldName + '[dateFrom][]" class="form-control" style="width:50%;" data-ui-datepicker="true" data-linz-date-format="' + dateFormat + '" required></span><span><input type="text" name="' + fieldName + '[dateTo][]" class="form-control" style="width:50%;" data-ui-datepicker="true" data-linz-date-format="' + dateFormat + '" required></span></template>');
    },
    ...
    bind: function dateRangeFilterBinder (fieldName, form, callback) {
        ...
        for (var i = 0; i < form[fieldName].dateFrom.length; i++) {
            ...
            html.push('<span><input type="text" name="' + fieldName + '[dateFrom][]" class="form-control" style="width:50%;" data-ui-datepicker="true" data-linz-date-format="' + dateFormat + '" data-linz-date-value="' + dateFromIso + '" required></span><span><input type="text" name="' + fieldName + '[dateTo][]" class="form-control" style="width:50%;" data-ui-datepicker="true" data-linz-date-format="' + dateFormat + '" data-linz-date-value="' + dateToIso + '" required></span>');
