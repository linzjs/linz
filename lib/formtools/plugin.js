...
var defaults = function (options) {
    ...
    options.grid.export.exclusion = options.grid.export.exclusion || '_id,dateCreated,dateModified,createdBy,modifiedBy';
...
var plugin = module.exports = function formtoolsPlugin (schema, options) {
    ...
    overview = overviewSettings(form, options.overview);
