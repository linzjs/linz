...
var formConfigDefault = function(keyName,schemaConfig,formConfig){
    ...
    var obj = {
        ...
        visible: formConfig.visible || true,
...
var getMongooseSchemaDefaultValue = function(key){

    if( typeof key.defaultValue === 'function') return undefined;
    ...
    for(var key in schema.paths){
        ...
        if(key !== '_id') {
            formConfig[key] = {
                ...
                default: getMongooseSchemaDefaultValue(schema.paths[key])
            };
        }
...
var plugin = module.exports = function formtoolsPlugin (schema, options) {
    ...
    options = formSettings(schema,options);
