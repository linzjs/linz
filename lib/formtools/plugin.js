...
var formConfigDefault = function(keyName,schemaConfig,formConfig){
    ...
    var obj = {
        ...
        filter: formConfig.filter // defaults to undefined
    };
    ...
    obj.create.filter = formConfig.create.filter || formConfig.filter;
    ...
    obj.edit.filter = formConfig.edit.filter || formConfig.filter;
