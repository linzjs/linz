    ...
    return new formist.Field('input', {
        ...
        theme: {
            field: function(label, content, helpText, field) {
                ...
                return (
                    '<div class="radio radio-inline"><label>' +
                    content +
                    ' ' +
...
module.exports = function(attrs) {
    function booleanWidget(name, field, value, record, formType) {
        var o = {
                attributes: {},
                label: {
                    label: field.label,
        ...
        elements.push(
            constructInput(
                ...
                name,
                'true',
                value === null ? false : utils.asBoolean(value) === true,
                field.disabled,
                field.required,
                attrs
            )
        ...
        elements.push(
            constructInput(
                ...
                name,
                'false',
                value === null ? false : utils.asBoolean(value) === false,
                field.disabled,
                field.required,
                attrs
            )
