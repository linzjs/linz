    ...
    function documentsWidget (name, field, value, record, formType, emdeddedDocumentForm) {
        ...
        return {
            ...
            render: function (theme) {
                ...
                return theme.field('<label class="' + o.label.attributes.class + '">' + o.label.label + '</label>', theme.control(content, { options: { attributes: o.attributes } }), '', { attributes: {} });
