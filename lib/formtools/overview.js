...
function setTabId (sections) {
    ...
    sections.forEach(function (section, sectionIndex) {
        ...
        section.forEach(function (tab, tabIndex) {
            ...
            // Replace white space from tab.lable with "-", make it lowercase and add the index number at the end.
...
/*
 * Update section.fields to an array of objects with label and value keys. Label should contain the field label and value should contain the field value.
 * e.g ({ label: '', value: '' })
...
function renderFields(record, model, section, callback) {
    ...
    // filter out invalid fileds from section
