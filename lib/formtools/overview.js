...
function renderCell (record, field, model, cb) {
    ...
    let fieldName = (typeof field === 'object') ? field.fieldName : field,
        ...
        renderer = cellRenderers[formField.type] ? formField.type : (model.schema.tree[fieldName] && model.schema.tree[fieldName].ref) ? 'reference' : (record[fieldName] && linz.mongoose.models[record[fieldName].ref]) ? 'referenceValue' : 'text';
