...
const setTemplateScripts = (req, res, templateScripts) =>
    new Promise((resolve, reject) => {
        ...
        const defaults = [
            ...
            {
                inHead: true,
                ...linz.get('scriptLocations')['jquery.min.js'],
            },
            {
                inHead: true,
                ...linz.get('scriptLocations')['jquery-migrate.min.js'],
            },
            linz.get('scriptLocations')['jquery-ui.min.js'],
            {
                inHead: true,
                ...linz.get('scriptLocations')['bootstrap.min.js'],
            },
            linz.get('scriptLocations')['moment.min.js'],
            linz.get('scriptLocations')['bootstrap-datetimepicker.min.js'],
            {
