    ...
    new Promise((resolve, reject) => {
        ...
        const defaults = [
            ...
            },
            {
                ...
                inHead: true,
                integrity:
                    'sha256-JklDYODbg0X+8sPiKkcFURb5z7RvlNMIaE3RA2z97vw=',
                src:
            ...
            },
            {
                crossorigin: 'anonymous',
                integrity:
                    'sha256-KM512VNnjElC30ehFwehXjx1YCHPiQkOPmqnrWtpccM=',
                src:
            ...
            },
            {
                crossorigin: 'anonymous',
                integrity:
                    'sha256-CutOzxCRucUsn6C6TcEYsauvvYilEniTXldPa6/wu0k=',
                src:
            ...
            },
            {
                crossorigin: 'anonymous',
                integrity:
                    'sha256-5YmaxAwMjIpMrVlK84Y/+NjCpKnFYa8bWWBbUHSBGfU=',
                src:
            ...
            {
                src: `${linz.get('admin path')}/public/js/ui.js?v8`,
            },
            {
