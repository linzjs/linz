...
module.exports = function versionsPlugin(schema, options) {
    ...
    options.settings.renderer =
        options.settings.renderer || linz.versions.renderers.overview;
    options.settings.cellRenderers = options.settings.cellRenderers || {};
    options.settings.cellRenderers.date =
        options.settings.cellRenderers.date ||
        linz.versions.renderers.cellRenderers.timestamp;
    options.settings.cellRenderers.reference =
        options.settings.cellRenderers.reference ||
        linz.versions.renderers.cellRenderers.reference;
    options.settings.cellRenderers.referenceName =
        options.settings.cellRenderers.referenceName ||
        linz.versions.renderers.cellRenderers.referenceName;
    options.settings.ignorePaths = options.ignorePaths || [];
