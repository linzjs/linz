...
const dateRangeQuery = (fromDateString, toDateString, dateFormat, offset = '+0:00') => {
        ...
        const $gte = moment(fromDateString, dateFormat).startOf('day').zone(offset).toISOString();
        const $lte = moment(toDateString, dateFormat).endOf('day').zone(offset).toISOString();
