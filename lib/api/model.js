 ...
 * @param {String} options.form The model form DSL.
 * @param {String} options.record The record.
 * @param {String} options.schema The model schema.
 * @param {String} [options.type='edit'] The form type.
 * @return {String} Returns the form HTML.
 */
const generateForm = (options) => new Promise((resolve, reject) => {
    ...
    linz.formtools.form.generateFormFromModel(schema, form, record, type, (err, form) => {
 ...
 * @return {String} Returns the form HTML.
 */
const generateFormString = (options) => new Promise((resolve, reject) => {
