...
Linz.prototype.setupModelRoutes = function () {
	...
	// setup a route for each model records delete handler
	this.f.addRoute.call(this, this.r.recordDelete, this.options.adminPath + '/:model/:id/delete', middleware.recordDelete());
