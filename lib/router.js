...
exports.setupAdminRoutes = function () {
    ...
    // map password reset
    router.get(linz.get('admin password reset path') + '/:id/:hash', middleware.namespace, middleware.passwordReset.get, routes.passwordReset.get);
    router.post(linz.get('admin password reset path'), middleware.passwordReset.post, routes.passwordReset.post);

    router.get('*', middleware.namespace, linz.middleware.exclusions(middleware.adminEnsureAuthenticated(), middleware.navigation, middleware.attributes), middleware.notifications);
    router.post('*', middleware.namespace, linz.middleware.exclusions(middleware.adminEnsureAuthenticated(), middleware.navigation, middleware.attributes));
