...
exports.setupAdminRoutes = function () {
    ...
    router.get('*', middleware.linz, linz.middleware.exclusions(middleware.adminEnsureAuthenticated(), middleware.navigation, middleware.attributes), middleware.notifications);
