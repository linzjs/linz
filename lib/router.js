...
exports.setupAdminRoutes = function () {
	...
	router.get('*', middleware.linz, middleware.adminEnsureAuthenticated(), middleware.navigation);
	router.post('*', middleware.linz, middleware.adminEnsureAuthenticated(), middleware.navigation);
