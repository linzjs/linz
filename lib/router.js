...
exports.setupModelRoutes = function () {
	...
	router.get('/model/:model/:id/edit', middleware.model, middleware.permissions('edit', 'model'), middleware.recordEdit(), routes.recordEdit);
...
exports.setupConfigsRoutes = function () {
    ...
    // config routes
    router.get('/configs/list', middleware.permissions('index', 'configs'), middleware.configList(), routes.configList);
    router.get('/config/:config/overview', middleware.config, middleware.permissions('overview', 'configs'), middleware.configOverview(), routes.configOverview);
    router.get('/config/:config/edit', middleware.config, middleware.permissions('edit', 'configs'), middleware.configEdit(), routes.configEdit);
    router.post('/config/:config/save', middleware.config, middleware.permissions('edit', 'configs'), middleware.configSave(), routes.configSave);
    router.get('/config/:config/default', middleware.config, middleware.permissions('reset', 'configs'), middleware.configDefault(), routes.configDefault);
    router.get('/config/:config/json', middleware.config, middleware.permissions('json', 'configs'), routes.configJSON);
