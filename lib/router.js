...
exports.setupModelRoutes = function () {
    ...
    router.post('/model/:model/create', middleware.permissions('canCreate', 'model'), middleware.namespaceForm, middleware.modelSave(), routes.modelSave);
    ...
    router.post('/model/:model/:id/save', middleware.permissions('canEdit', 'model'), middleware.namespaceForm, middleware.recordSave(), routes.recordSave);
