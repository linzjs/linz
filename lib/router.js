...
exports.setupModelRoutes = function () {
    ...
    router.get('/model/:model/new', middleware.permissions('canCreate', 'model'), routes.modelCreate);
    router.post('/model/:model/create', middleware.permissions('canCreate', 'model'), linz.api.middleware.setModelForm(), routes.modelSave);
    ...
    router.post('/model/:model/:id/save', middleware.permissions('canEdit', 'model'), linz.api.middleware.setModelForm(), linz.api.middleware.setRecord(), routes.recordSave);
