...
exports.setupModelRoutes = function () {
    ...
    router.get('/model/:model/new', middleware.namespaceForm, middleware.permissions('canCreate', 'model'), routes.modelCreate);
    router.post('/model/:model/create', middleware.namespaceForm, middleware.permissions('canCreate', 'model'), middleware.modelSave(), routes.modelSave);
    ...
    router.post('/model/:model/:id/save', middleware.namespaceForm, middleware.permissions('canEdit', 'model'), middleware.recordSave(), routes.recordSave);
