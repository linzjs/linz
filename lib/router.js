...
exports.setupAdminRoutes = function () {
    ...
    router.get('*', linz.api.middleware.setLinzNamespace(), linz.middleware.exclusions(middleware.adminEnsureAuthenticated(), middleware.navigation, middleware.attributes), publicMiddleware.notifications);
