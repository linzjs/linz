...
var express = require('express'),
    ...
    publicMiddleware = require('../middleware-public'),
    router;
...
exports.setupAdminRoutes = function () {
    ...
    // map password reset
    router.get(linz.get('admin password reset path') + '/:id/:hash', publicMiddleware.namespace, middleware.passwordReset.get, routes.passwordReset.get);
    router.post(linz.get('admin password reset path'), middleware.passwordReset.post, routes.passwordReset.post);

    router.get('*', publicMiddleware.namespace, linz.middleware.exclusions(middleware.adminEnsureAuthenticated(), middleware.navigation, middleware.attributes), publicMiddleware.notifications);
    router.post('*', publicMiddleware.namespace, linz.middleware.exclusions(middleware.adminEnsureAuthenticated(), middleware.navigation, middleware.attributes));
...
exports.setupModelRoutes = function () {
    ...
    router.get('/model/:model/new', middleware.namespaceForm, middleware.permissions('canCreate', 'model'), middleware.routesHook, routes.modelCreate);
    router.post('/model/:model/create', middleware.namespaceForm, middleware.permissions('canCreate', 'model'), middleware.modelSave(), middleware.routesHook, routes.modelSave);
    ...
    router.get('/model/:model/:id/edit', middleware.namespaceForm, middleware.permissions('canEdit', 'model'), middleware.recordEdit(), middleware.routesHook, routes.recordEdit);
    router.post('/model/:model/:id/save', middleware.namespaceForm, middleware.permissions('canEdit', 'model'), middleware.recordSave(), middleware.routesHook, routes.recordSave);
    router.get('/model/:model/:id/delete', middleware.permissions('canDelete', 'model'), middleware.recordDelete(), middleware.routesHook, routes.recordDelete);
    ...
    // version routes
    router.get('/model/:model/:id/versions-compare/:revisionAId/:revisionBId', middleware.namespaceForm, middleware.modelVersionsCompare.get, routes.modelVersionsCompare.get);
    router.get('/model/:model/:id/versions-rollback/:revisionAId/:revisionBId', middleware.namespaceForm, middleware.modelVersionsRollback.get, routes.modelVersionsRollback.get);
    router.post('/model/:model/:id/versions-rollback/:revisionAId/:revisionBId', middleware.namespaceForm, middleware.modelVersionsRollback.post, routes.modelVersionsRollback.post);

    // concurrency control routes
    router.post('/model/:model/:id/change/:versionNo?', middleware.namespaceForm, middleware.recordChange);
