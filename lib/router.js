...
exports.setupAdminRoutes = function () {
    ...
    router.get('/forgot-your-password', helpers.linz(), middleware.forgottenPassword.get, routes.forgottenPassword.get);
    router.post('/forgot-your-password', helpers.linz(), middleware.forgottenPassword.post, routes.forgottenPassword.post);
