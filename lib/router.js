...
exports.setupModelRoutes = function () {
	...
	router.get('/model/:model/list', middleware.model, middleware.modelIndex.get, routes.modelIndex);
    router.post('/model/:model/list', middleware.model, middleware.modelIndex.post, routes.modelIndex);
	router.get('/model/:model/new', middleware.model, middleware.modelCreate(), routes.modelCreate);
	router.post('/model/:model/create', middleware.model, middleware.modelSave(), routes.modelSave);
    router.get('/model/:model/export', middleware.model, middleware.modelExport.get, routes.modelExport.get);
    router.post('/model/:model/export', middleware.model, middleware.modelExport.post);

	// record routes
	router.get('/model/:model/:id/overview', middleware.model, middleware.recordOverview(), routes.recordOverview);
	router.get('/model/:model/:id/edit', middleware.model, middleware.recordEdit(), routes.recordEdit);
	router.post('/model/:model/:id/save', middleware.model, middleware.recordSave(), routes.recordSave);
	router.get('/model/:model/:id/delete', middleware.model, middleware.recordDelete(), routes.recordDelete);
	router.get('/model/:model/:id/json', middleware.model, routes.recordJSON);
