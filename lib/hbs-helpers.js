...
Handlebars.registerHelper('renderDiffs', function(results, options) {
    ...
    var html = '',
        ...
        renderClass = function renderClass (val) {
            if (val === 'N') {
                return 'class="new"';
            }
    ...
    results.forEach(function (result, index) {
        ...
        if (result.textDiff) {
            ...
            result.textDiff.forEach(function(part){
                ...
                diffHtml += (color === 'green' ? '<span class="added">' + part.value + '</span>' : '');
        ...
        str += '<tr>'
                ...
                + '<td ' + renderClass(editType)+ '>' + renderValue(rhs) + '</td>';
             + '<tr>';
