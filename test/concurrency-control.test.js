...
describe('concurrency control', () => {
    ...
    describe('extends the schema', () => {
        ...
        test('should throw error if options.modifiedByProperty is not defined in the provided schema', () => {
            ...
            }).toThrow('settings.modifiedByProperty "' + modifiedByProperty + '" has been provided, but it is not defined in your schema.');
        ...
        test('should throw error if options.modifiedByProperty is included in the exclusions settings', () => {
            ...
            }).toThrow('settings.modifiedByProperty "' + modifiedByProperty + '" is required and cannot be excluded.');
    ...
    describe('sets versions options', () => {
        ...
        describe('defaults', () => {
            ...
            test('options.settings.exclusions should defaults to ["_id","dateCreated","dateModified"]', () => {
                ...
                expect(ccSettings.settings.exclusions[1]).toEqual('dateCreated');
                expect(ccSettings.settings.exclusions[2]).toEqual('dateModified');
